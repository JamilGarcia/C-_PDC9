...
string Contacto::obtenerTelefono() const { return telefono; }
...
string Contacto::obtenerNombre() const { return nombre; }
void Contacto::establecerNombre(const string &Nombre)
{
    copiar_cadena(Nombre, nombre, 50);
}
void Contacto::establecerId(const int Id) { id = Id; }
int Contacto::obtenerId() const { return id; }
